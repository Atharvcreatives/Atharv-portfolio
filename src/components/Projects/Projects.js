        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              // ghLink="https://github.com/atharvcreatives4419/Plant_AI"
          ...
          {/* <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/atharvcreatives4419/AI_For_Social_Good"
          ...
          {/* <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/atharvcreatives4419/Face_And_Emotion_Detection"
